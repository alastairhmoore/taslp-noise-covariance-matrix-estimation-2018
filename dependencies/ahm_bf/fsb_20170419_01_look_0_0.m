function[] = fsb_20170419_01_look_0_0(...
...
W_fixed_mono_t = conj(fcn_20170419_01_fsb_weights(rH_fixed_mono_t));
...
for iblock = 1:nBlocks
    ...
    fprintf('Apply  ');    
    Y_fixed_mono = sum(bsxfun(@times,X,W_fixed_mono),2);

      
    fprintf('Inv STFTs  ');
    [tmp_y_fixed_mono,y_fixed_mono_tail] = stft_v2('inv',Y_fixed_mono,pm,y_fixed_mono_tail);
