function[] = mvdr_20170425_01_binaural_look_0_0_sphiso(...
...
%mvdr_20170425_01_binaural_look_0_0_sphiso implements an mvdr
...
%
%Usage:
%  mvdr_20170425_01_binaural_look_0_0_sphiso(...
...
W_fixed_left_t = conj(mvdr_fcn(R,rH_fixed_left_t));
W_fixed_right_t = conj(mvdr_fcn(R,rH_fixed_right_t));
...
for iblock = 1:nBlocks
    ...
    fprintf('Apply  ');    
    Y_fixed_left = sum(bsxfun(@times,X_cola,W_fixed_left),2);
    Y_fixed_right = sum(bsxfun(@times,X_cola,W_fixed_right),2); 
